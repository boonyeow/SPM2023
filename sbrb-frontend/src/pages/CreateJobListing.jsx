              ...
              <Box w="90%" p={20}>
                <Grid
                  ...
                  <GridItem colSpan={2}>
                    <FormControl>
                      ...
                      {selectedSkills.length > 0 && (
                        <div>
                          <Text mt="8px">Selected Skills:</Text>{" "}
                          <Text fontSize={"12px"}>
                            Click the badge to remove skill
                          </Text>
                  ...
                  <GridItem colSpan={3}>
                    ...
                    {derivedDepartment && (
                      <Text>Department: {derivedDepartment}</Text>
                    )}
                  </GridItem>
                  ...
                  <GridItem colSpan={2}>
                    ...
                    <Stack spacing={4}>
                      ...
                      {selectedCountry && (
                        <Text>You have selected: {selectedCountry}</Text>
                      )}
                    </Stack>
                  </GridItem>
